	...
	<section class="content">
		<div class="row">			
			...
			<div class="col-md-12">
				...
				<div class="box" >
					<div class="box-header">
						<h3 class="box-title">Số lượng bò thực tế còn lại theo quốc gia</h3>										
					</div><!--./box-header -->
			...
			<div class="col-md-12">
				...
				<div class="box" >
					<div class="box-header">
						<h3 class="box-title">Số lượng bò thực tế còn lại theo khu vực</h3>										
					</div><!--./box-header -->
					<div class="box-body table-responsive">			
			...
			<div class="col-md-12">
				...
				<div class="box" >
					<div class="box-header">
						<h3 class="box-title">Số lượng bò thực tế còn lại theo các đối tác xuất khẩu</h3>										
					</div><!--./box-header -->
					<div class="box-body table-responsive">			
			...
			<div class = "col-md-6">
	            ...
	            <div class="box box-primary">
	                <div class="box-header">
	                  <h3 class="box-title">Biểu đồ so sánh tỷ lệ tổng đàn bò thực tế giữa các khu vực</h3>
	                </div>
	                <div class="box-body chart-responsive">
			...
			<div class = "col-md-6">
	            ...
	            <div class="box box-primary">
	                <div class="box-header">
	                  <h3 class="box-title">Biểu đồ so sánh tỷ lệ tổng đàn bò thực tế giữa các đối tác xuất khẩu</h3>
	                </div>
	                <div class="box-body chart-responsive">
			...
			<div class = "col-md-12">
	            ...
	            <div class="box box-primary">
	                <div class="box-header">
	                  <h3 class="box-title">Biểu đồ phân bổ chi tiết đàn bò thực tế giữa các quốc gia</h3>
	                </div>
	                <div class="box-body chart-responsive">
	...
	<script type="text/javascript">
		...
		$("document").ready(function(){
	        ...
	        $('#real-quantity-country-table tbody tr').on("click",function(event){
	        	id = this.id;
	        	url = "{{URL::route('front_report_livestock_real_quantity_get')}}";
	        	url += "/" + id;
