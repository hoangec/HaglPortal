...
<div class="content-wrapper">
	...
	<section class="content-header">
	  <h1>
	    Báo cáo tổng đàn bò thịt thực tế từng quốc gia
	  </h1>
	  <ol class="breadcrumb">
			...
			<div class="col-md-12">
				...
				<div class="box" >
					<div class="box-header">
						<h3 class="box-title">Số lượng bò thực tế tại {{$data['country']['name'] }} theo công ty</h3>										
					</div><!--./box-header -->
	...
	<script type="text/javascript">
		function format(value){
			...
			$.each(companyData.feedlots,function(key,feedlot){
				var quantity = JSON.parse(feedlot.pivot.real_quantity);
