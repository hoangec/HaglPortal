...
Route::group(array('prefix'=>'dashboard',"before"=>"check_user"),function(){
	...
	Route::get('reports/livestock/index',array("as"=>"front_report_livestock_index_get","uses"=>"Controllers\Domain\Dashboard\Report\LiveStockController@getIndex"));
	...
	Route::get('reports/livestock/mortality-quantity/{country?}',array("as"=>"front_report_livestock_mortality_quantity_get","uses"=>"Controllers\Domain\Dashboard\Report\LiveStockController@getMortalityQuantity"));
